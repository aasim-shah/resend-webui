...
export function getAllAccounts(userId?: string): ResendAccount[] {
  ...
  // 1. Default Primary .env Profile (Always available so every user has an active profile)
  ...
  // 2. Additional .env Profiles (CoreByte Studio & FeedWink)
  ...
  // 3. Custom accounts stored in database for this userId
